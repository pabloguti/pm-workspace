...
check_contains "docs/rules/domain/backup-protocol.md" "AES-256-CBC" "backup-protocol.md"
check_contains "docs/rules/domain/backup-protocol.md" "PBKDF2" "backup-protocol.md"
check_contains "docs/rules/domain/backup-protocol.md" "100.000" "backup-protocol.md"
check_contains "docs/rules/domain/backup-protocol.md" "NextCloud" "backup-protocol.md"
check_contains "docs/rules/domain/backup-protocol.md" "Google Drive" "backup-protocol.md"
check_contains "docs/rules/domain/backup-protocol.md" "SHA-256" "backup-protocol.md"
check_contains "docs/rules/domain/backup-protocol.md" "7 backups" "backup-protocol.md"
check_contains "docs/rules/domain/backup-protocol.md" "profiles/users" "backup-protocol.md"
check_contains "docs/rules/domain/backup-protocol.md" "CLAUDE.local.md" "backup-protocol.md"
check_contains "docs/rules/domain/backup-protocol.md" "devops-pat" "backup-protocol.md"
