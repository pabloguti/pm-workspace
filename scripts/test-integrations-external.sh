...
test_case "jira-connect mentions jira" "grep -q -i 'jira' $REPO_ROOT/.opencode/commands/jira-connect.md"
test_case "github-projects mentions github" "grep -q -i 'github' $REPO_ROOT/.opencode/commands/github-projects.md"
test_case "slack-search mentions slack" "grep -q -i 'slack' $REPO_ROOT/.opencode/commands/slack-search.md"
test_case "sentry-bugs mentions sentry" "grep -q -i 'sentry' $REPO_ROOT/.opencode/commands/sentry-bugs.md"
