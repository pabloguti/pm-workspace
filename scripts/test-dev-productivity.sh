...
check_file ".opencode/commands/my-sprint.md" "my-sprint.md exists"
check_content ".opencode/commands/my-sprint.md" "name: my-sprint" "Has correct name"
check_content ".opencode/commands/my-sprint.md" "Cycle time" "Tracks cycle time"
check_content ".opencode/commands/my-sprint.md" "PRs" "Shows PR status"
check_content ".opencode/commands/my-sprint.md" "Modo agente" "Has agent mode"
check_content ".opencode/commands/my-sprint.md" "comparar rendimiento" "No team comparisons"
echo ""

echo "📋 2. My Focus Command"
check_file ".opencode/commands/my-focus.md" "my-focus.md exists"
check_content ".opencode/commands/my-focus.md" "name: my-focus" "Has correct name"
check_content ".opencode/commands/my-focus.md" "Bloqueante" "Prioritizes blockers"
check_content ".opencode/commands/my-focus.md" "Spec SDD" "Loads spec context"
check_content ".opencode/commands/my-focus.md" "Agent-notes" "Loads agent-notes"
check_content ".opencode/commands/my-focus.md" "Modo agente" "Has agent mode"
check_content ".opencode/commands/my-focus.md" "ejecutar comandos sin confirmación" "No auto-execution"
echo ""

echo "📋 3. My Learning Command"
check_file ".opencode/commands/my-learning.md" "my-learning.md exists"
check_content ".opencode/commands/my-learning.md" "name: my-learning" "Has correct name"
check_content ".opencode/commands/my-learning.md" "agent: task" "Uses task agent"
check_content ".opencode/commands/my-learning.md" "best practices" "Compares with best practices"
check_content ".opencode/commands/my-learning.md" "Lo que haces bien" "Includes strengths"
check_content ".opencode/commands/my-learning.md" "compartir resultados" "Private results"
check_content ".opencode/commands/my-learning.md" "Modo agente" "Has agent mode"
echo ""

echo "📋 4. Code Patterns Command"
check_file ".opencode/commands/code-patterns.md" "code-patterns.md exists"
check_content ".opencode/commands/code-patterns.md" "name: code-patterns" "Has correct name"
check_content ".opencode/commands/code-patterns.md" "agent: task" "Uses task agent"
check_content ".opencode/commands/code-patterns.md" "Repository" "Detects repository pattern"
check_content ".opencode/commands/code-patterns.md" "Strategy" "Detects strategy pattern"
check_content ".opencode/commands/code-patterns.md" "Modo agente" "Has agent mode"
echo ""
