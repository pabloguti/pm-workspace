...
check_file "docs/rules/domain/savia-hub-config.md" "Config rule exists"
check_lines "docs/rules/domain/savia-hub-config.md" 150 "Config rule within limit"
check_content "docs/rules/domain/savia-hub-config.md" "SAVIA_HUB_PATH" "Has path config"
check_content "docs/rules/domain/savia-hub-config.md" "SAVIA_HUB_REMOTE" "Has remote config"
check_content "docs/rules/domain/savia-hub-config.md" "company/" "Has company dir"
check_content "docs/rules/domain/savia-hub-config.md" "clients/" "Has clients dir"
check_content "docs/rules/domain/savia-hub-config.md" "users/" "Has users dir"

check_file "docs/rules/domain/savia-hub-offline.md" "Offline rule exists"
check_lines "docs/rules/domain/savia-hub-offline.md" 150 "Offline rule within limit"
check_content "docs/rules/domain/savia-hub-offline.md" "flight.mode" "Has flight mode"
check_content "docs/rules/domain/savia-hub-offline.md" "sync-queue" "Has sync queue"
check_content "docs/rules/domain/savia-hub-offline.md" "NUNCA auto-resolver" "Has safety rule"
