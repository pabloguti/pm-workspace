...
check_file ".opencode/commands/okr-define.md" "okr-define.md exists"
check_content ".opencode/commands/okr-define.md" "name: okr-define" "Has correct name"
check_content ".opencode/commands/okr-define.md" "Objectives y Key Results" "References OKRs"
check_content ".opencode/commands/okr-define.md" "Modo agente" "Has agent mode"
echo ""

echo "📋 2. OKR Track Command"
check_file ".opencode/commands/okr-track.md" "okr-track.md exists"
check_content ".opencode/commands/okr-track.md" "name: okr-track" "Has correct name"
check_content ".opencode/commands/okr-track.md" "Tracking automático" "References tracking"
check_content ".opencode/commands/okr-track.md" "Modo agente" "Has agent mode"
check_content ".opencode/commands/okr-track.md" "🟢🟡🔴" "References traffic lights"
echo ""

echo "📋 3. OKR Align Command"
check_file ".opencode/commands/okr-align.md" "okr-align.md exists"
check_content ".opencode/commands/okr-align.md" "name: okr-align" "Has correct name"
check_content ".opencode/commands/okr-align.md" "alineación" "References alignment"
check_content ".opencode/commands/okr-align.md" "Modo agente" "Has agent mode"
check_content ".opencode/commands/okr-align.md" "orphan" "References orphan projects"
echo ""

echo "📋 4. Strategy Map Command"
check_file ".opencode/commands/strategy-map.md" "strategy-map.md exists"
check_content ".opencode/commands/strategy-map.md" "name: strategy-map" "Has correct name"
check_content ".opencode/commands/strategy-map.md" "mapa estratégico" "References strategy map"
check_content ".opencode/commands/strategy-map.md" "Modo agente" "Has agent mode"
check_content ".opencode/commands/strategy-map.md" "iniciativas" "References initiatives"
echo ""
