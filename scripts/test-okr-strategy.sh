...
check_content ".claude/rules/domain/role-workflows.md" "okr-track" "Role-workflows includes /okr-track"
check_content ".claude/rules/domain/role-workflows.md" "okr-align" "Role-workflows includes /okr-align"
check_content ".claude/rules/domain/role-workflows.md" "strategy-map" "Role-workflows includes /strategy-map"
echo ""
