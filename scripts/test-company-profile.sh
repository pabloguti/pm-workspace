...
check_file ".claude/commands/company-setup.md" "company-setup.md exists"
check_content ".claude/commands/company-setup.md" "name: company-setup" "Has correct name"
check_content ".claude/commands/company-setup.md" "onboarding" "References onboarding"
check_content ".claude/commands/company-setup.md" "Modo agente" "Has agent mode"
echo ""

echo "📋 2. Company Edit Command"
check_file ".claude/commands/company-edit.md" "company-edit.md exists"
check_content ".claude/commands/company-edit.md" "name: company-edit" "Has correct name"
check_content ".claude/commands/company-edit.md" "edit\|modify" "References edit/modify"
check_content ".claude/commands/company-edit.md" "Modo agente" "Has agent mode"
echo ""

echo "📋 3. Company Show Command"
check_file ".claude/commands/company-show.md" "company-show.md exists"
check_content ".claude/commands/company-show.md" "name: company-show" "Has correct name"
check_content ".claude/commands/company-show.md" "profile\|resumen" "References profile/resumen"
check_content ".claude/commands/company-show.md" "Modo agente" "Has agent mode"
echo ""

echo "📋 4. Company Vertical Command"
check_file ".claude/commands/company-vertical.md" "company-vertical.md exists"
check_content ".claude/commands/company-vertical.md" "name: company-vertical" "Has correct name"
check_content ".claude/commands/company-vertical.md" "vertical\|sector\|industria" "References vertical/sector/industria"
check_content ".claude/commands/company-vertical.md" "Modo agente" "Has agent mode"
echo ""
