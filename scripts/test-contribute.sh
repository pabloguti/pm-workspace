...
check_file ".opencode/commands/contribute.md" ".opencode/commands/contribute.md"
check_file ".opencode/commands/feedback.md" ".opencode/commands/feedback.md"
check_file "docs/rules/domain/community-protocol.md" "community-protocol.md"
...
check_contains ".opencode/commands/contribute.md" "name: contribute" "contribute.md"
check_contains ".opencode/commands/contribute.md" "pr" "contribute.md"
check_contains ".opencode/commands/contribute.md" "idea" "contribute.md"
check_contains ".opencode/commands/contribute.md" "bug" "contribute.md"
check_contains ".opencode/commands/contribute.md" "status" "contribute.md"
check_contains ".opencode/commands/contribute.md" "validate_privacy" "contribute.md"
check_contains ".opencode/commands/contribute.md" "community-protocol" "contribute.md"
check_contains ".opencode/commands/contribute.md" "Savia" "contribute.md"
check_contains ".opencode/commands/contribute.md" "NUNCA" "contribute.md"

echo ""
echo "📋 Contenido de feedback.md (comando)"
check_contains ".opencode/commands/feedback.md" "name: feedback" "feedback.md"
check_contains ".opencode/commands/feedback.md" "bug" "feedback.md"
check_contains ".opencode/commands/feedback.md" "idea" "feedback.md"
check_contains ".opencode/commands/feedback.md" "improve" "feedback.md"
check_contains ".opencode/commands/feedback.md" "list" "feedback.md"
check_contains ".opencode/commands/feedback.md" "search" "feedback.md"
check_contains ".opencode/commands/feedback.md" "contribute.sh" "feedback.md"
check_contains ".opencode/commands/feedback.md" "Savia" "feedback.md"
check_contains ".opencode/commands/feedback.md" "NUNCA" "feedback.md"

echo ""
echo "🔒 Contenido de community-protocol.md"
check_contains "docs/rules/domain/community-protocol.md" "Privacy-first" "community-protocol.md"
check_contains "docs/rules/domain/community-protocol.md" "PATs" "community-protocol.md"
check_contains "docs/rules/domain/community-protocol.md" "Emails corporativos" "community-protocol.md"
check_contains "docs/rules/domain/community-protocol.md" "CLAUDE.local.md" "community-protocol.md"
check_contains "docs/rules/domain/community-protocol.md" "validate_privacy" "community-protocol.md"
check_contains "docs/rules/domain/community-protocol.md" "from-savia" "community-protocol.md"
check_contains "docs/rules/domain/community-protocol.md" "Plantilla de PR" "community-protocol.md"
check_contains "docs/rules/domain/community-protocol.md" "Plantilla de Issue" "community-protocol.md"

echo ""
echo "🪝 Integración con session-init.sh"
check_contains ".opencode/hooks/session-init.sh" "contribute" "session-init.sh"
check_contains ".opencode/hooks/session-init.sh" "RANDOM" "session-init.sh"
check_contains ".opencode/hooks/session-init.sh" "/contribute" "session-init.sh"
check_contains ".opencode/hooks/session-init.sh" "/feedback" "session-init.sh"
