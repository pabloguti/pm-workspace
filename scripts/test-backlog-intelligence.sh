...
check_content ".claude/rules/domain/role-workflows.md" "backlog-prioritize" "Role-workflows includes /backlog-prioritize"
check_content ".claude/rules/domain/role-workflows.md" "outcome-track" "Role-workflows includes /outcome-track"
echo ""
