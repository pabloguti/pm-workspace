...
check_file ".opencode/commands/ai-safety-config.md" "ai-safety-config.md exists"
check_content ".opencode/commands/ai-safety-config.md" "name: ai-safety-config" "Has correct name"
check_content ".opencode/commands/ai-safety-config.md" "supervisión humana" "References human oversight"
check_content ".opencode/commands/ai-safety-config.md" "agent: none" "Has agent: none"
echo ""

echo "📋 2. AI Confidence Command"
check_file ".opencode/commands/ai-confidence.md" "ai-confidence.md exists"
check_content ".opencode/commands/ai-confidence.md" "name: ai-confidence" "Has correct name"
check_content ".opencode/commands/ai-confidence.md" "confianza" "References confidence"
check_content ".opencode/commands/ai-confidence.md" "agent: task" "Has agent: task"
echo ""

echo "📋 3. AI Boundary Command"
check_file ".opencode/commands/ai-boundary.md" "ai-boundary.md exists"
check_content ".opencode/commands/ai-boundary.md" "name: ai-boundary" "Has correct name"
check_content ".opencode/commands/ai-boundary.md" "límites" "References boundaries"
check_content ".opencode/commands/ai-boundary.md" "agent: none" "Has agent: none"
echo ""

echo "📋 4. AI Incident Command"
check_file ".opencode/commands/ai-incident.md" "ai-incident.md exists"
check_content ".opencode/commands/ai-incident.md" "name: ai-incident" "Has correct name"
check_content ".opencode/commands/ai-incident.md" "incidentes" "References incidents"
check_content ".opencode/commands/ai-incident.md" "agent: task" "Has agent: task"
echo ""

echo "📋 5. Line Count Validation (≤150 lines each)"
CONFIG_LINES=$(wc -l < .opencode/commands/ai-safety-config.md)
CONFIDENCE_LINES=$(wc -l < .opencode/commands/ai-confidence.md)
BOUNDARY_LINES=$(wc -l < .opencode/commands/ai-boundary.md)
INCIDENT_LINES=$(wc -l < .opencode/commands/ai-incident.md)
...
check_content ".opencode/commands/ai-safety-config.md" "context_cost: low" "ai-safety-config has context_cost"
check_content ".opencode/commands/ai-confidence.md" "context_cost: low" "ai-confidence has context_cost"
check_content ".opencode/commands/ai-boundary.md" "context_cost: low" "ai-boundary has context_cost"
check_content ".opencode/commands/ai-incident.md" "context_cost: medium" "ai-incident has context_cost"
echo ""

echo "📋 11. Content Validation"
check_content ".opencode/commands/ai-safety-config.md" "inform\|recommend\|decide\|execute" "ai-safety-config defines 4 levels"
check_content ".opencode/commands/ai-confidence.md" "ALTA\|MEDIA\|BAJA" "ai-confidence defines confidence levels"
check_content ".opencode/commands/ai-boundary.md" "Matriz de Límites" "ai-boundary has boundary matrix"
check_content ".opencode/commands/ai-incident.md" "BIAS\|HALLUCINATION\|CONTEXT-LOSS\|OUTDATED" "ai-incident defines incident types"
echo ""

echo "📋 12. Regression (existing commands)"
check_file ".opencode/commands/ai-model-card.md" "ai-model-card still exists"
check_file ".opencode/commands/ai-risk-assessment.md" "ai-risk-assessment still exists"
check_file ".opencode/commands/async-standup.md" "async-standup still exists"
check_file ".opencode/commands/backlog-groom.md" "backlog-groom still exists (v0.56.0)"
check_file ".opencode/commands/okr-define.md" "okr-define still exists (v0.55.0)"
echo ""
