...
check_file ".opencode/commands/update.md" ".opencode/commands/update.md"
...
check_contains ".opencode/commands/update.md" "name: update" "update.md"
check_contains ".opencode/commands/update.md" "check" "update.md"
check_contains ".opencode/commands/update.md" "install" "update.md"
check_contains ".opencode/commands/update.md" "auto-on" "update.md"
check_contains ".opencode/commands/update.md" "auto-off" "update.md"
check_contains ".opencode/commands/update.md" "status" "update.md"
check_contains ".opencode/commands/update.md" "Savia" "update.md"
check_contains ".opencode/commands/update.md" "context-map.md" "update.md"
check_contains ".opencode/commands/update.md" "NUNCA" "update.md"
check_contains ".opencode/commands/update.md" "Datos protegidos" "update.md"
check_contains ".opencode/commands/update.md" "profiles/users" "update.md"
check_contains ".opencode/commands/update.md" "YAML" "update.md"

echo ""
echo "🪝 Integración con session-init.sh"
check_contains ".opencode/hooks/session-init.sh" "Update:" "session-init.sh"
check_contains ".opencode/hooks/session-init.sh" "update-config" "session-init.sh"
check_contains ".opencode/hooks/session-init.sh" "auto_check" "session-init.sh"
check_contains ".opencode/hooks/session-init.sh" "last_check" "session-init.sh"
check_contains ".opencode/hooks/session-init.sh" "604800" "session-init.sh"
check_contains ".opencode/hooks/session-init.sh" "releases/latest" "session-init.sh"
check_contains ".opencode/hooks/session-init.sh" "/update" "session-init.sh"
...
for path in "profiles/users" "projects" "output" "CLAUDE.local.md" "decision-log.md" "pm-config.local.md"; do
  check_contains ".opencode/commands/update.md" "$path" "update.md protección de $path"
