...
check_content ".claude/rules/domain/role-workflows.md" "vertical-healthcare" "Role workflows includes vertical-healthcare"
check_content ".claude/rules/domain/role-workflows.md" "vertical-finance" "Role workflows includes vertical-finance"
check_content ".claude/rules/domain/role-workflows.md" "vertical-legal" "Role workflows includes vertical-legal"
check_content ".claude/rules/domain/role-workflows.md" "vertical-education" "Role workflows includes vertical-education"
echo ""
