...
check "Checks OpenCode" "grep -qi 'command -v opencode\|Get-Command opencode' '$REPO_ROOT/install.sh'"
check "Installs OpenCode" "grep -q 'opencode\|opencode-ai' '$REPO_ROOT/install.sh'"
check "Has next steps output" "grep -qi 'next steps\|cd.*opencode' '$REPO_ROOT/install.sh'"
...
check "Checks OpenCode" "grep -qi 'Get-Command opencode\|opencode' '$REPO_ROOT/install.ps1'"
check "Installs OpenCode" "grep -q 'opencode\|opencode-ai' '$REPO_ROOT/install.ps1'"
