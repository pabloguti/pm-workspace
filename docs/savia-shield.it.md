...
| Hook audit | `.opencode/hooks/data-sovereignty-audit.sh` | PostToolUse async: ri-scansione file completo |
...
| Force-push guard | `.opencode/hooks/block-force-push.sh` | Blocca force-push, push su main, amend |
