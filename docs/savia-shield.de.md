...
| Audit-Hook | `.opencode/hooks/data-sovereignty-audit.sh` | PostToolUse async: erneuter Scan der vollständigen Datei |
...
| Force-Push-Guard | `.opencode/hooks/block-force-push.sh` | Blockiert Force-Push, Push auf main, Amend |
