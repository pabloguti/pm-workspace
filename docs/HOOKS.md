...
bash /home/monica/savia/.claude/hooks/block-credential-leak.sh < test-input.json

# With debug output
bash -x /home/monica/savia/.claude/hooks/block-credential-leak.sh < test-input.json
