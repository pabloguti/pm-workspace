...
| Modificar | .opencode/hooks/session-init.sh | Inyectar fecha en turno humano |
| Crear | .opencode/hooks/validate-system-prompt-static.sh | Validador |
| Modificar | docs/rules/domain/pm-config.md | Constantes CACHE_TTL_* |
| Crear | tests/test-prompt-caching-2026.bats | Suite BATS |
| Modificar | .opencode/commands/dev-session.md | Marcar como ttl=1h |
| Modificar | .opencode/commands/overnight-sprint.md | Marcar como ttl=1h |
| Modificar | .opencode/commands/project-audit.md | Marcar como ttl=1h |
